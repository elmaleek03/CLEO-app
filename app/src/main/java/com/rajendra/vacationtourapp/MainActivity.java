...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recentsDataList.add(new RecentsData("Mata Pelajaran","Sejarah","Tempat Bersejarah",R.drawable.recentimage1));
        recentsDataList.add(new RecentsData("Mata Pelajaran","Sejarah","Tempat Berejarah",R.drawable.recentimage2));
        recentsDataList.add(new RecentsData("Mata Pelajaran","Sejarah","Tempat Bersejarah",R.drawable.recentimage1));
        recentsDataList.add(new RecentsData("Mata Pelajaran","Sejarah","Tempat Bersejarah",R.drawable.recentimage2));
        recentsDataList.add(new RecentsData("Mata Pelajaran","Sejarah","Tempat Bersejarah",R.drawable.recentimage1));
        recentsDataList.add(new RecentsData("Mata Pelajaran","Sejarah","Tempat Bersejarah",R.drawable.recentimage2));
        ...
        topPlacesDataList.add(new TopPlacesData("Mata Pelajaran","Sejarah","Tempat Bersejarah",R.drawable.topplaces));
        topPlacesDataList.add(new TopPlacesData("Mata Pelajaran","Sejarah","$Tempat Bersejarah",R.drawable.topplaces));
        topPlacesDataList.add(new TopPlacesData("Mata Pelajaran","Sejarah","Tempat Bersejarah",R.drawable.topplaces));
        topPlacesDataList.add(new TopPlacesData("Mata Pelajaran","Sejarah","Tempat Bersejarah",R.drawable.topplaces));
        topPlacesDataList.add(new TopPlacesData("Mata Pelajaran","Sejarah","Tempat Bersejarah",R.drawable.topplaces));
